	...
	const contactFaqs = [
		{
			...
			answer:
				'We guarantee a response from one of our growth strategists within 24 business hours of your inquiry.',
		},
		{
			question: 'What should I prepare for our first call?',
			answer:
				"It's helpful to have a general idea of your current marketing budget, your primary growth bottlenecks, and any historical data (like GA4 or ad account access) ready for discussion.",
		},
		{
			question: 'Do you offer free audits?',
			answer:
				'Yes. For qualified leads, we provide a comprehensive technical and performance audit at no cost to demonstrate exactly where we can add value.',
		},
	];
				...
				<section className='contact-hero'>
					<div className='container'>
						...
						<p className='contact-hero-desc'>
							Ready to unlock predictable revenue growth? Reach out to us and
							let&apos;s discuss how we can help your business scale.
						</p>
					</div>
				</section>
								...
								<div className='contact-cards'>
									<div className='contact-card'>
										...
										<div>
											...
											<div className='contact-card-phone-list'>
												<a
													href='tel:8082012995'
									...
									<div className='contact-card'>
										...
										<div>
											...
											<span className='contact-card-value'>
												B-2047 ZARA ROSSA, Sector 112, Bajghera,
												<br />
												Palam Vihar (Gurgaon), Palam Vihar,
												<br />
