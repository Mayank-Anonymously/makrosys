...
const dubaiVideoUrl =
	'https://videos.pexels.com/video-files/27607374/12184322_2160_3840_60fps.mp4';
...
const services = [
	{
		...
		solution:
			'Premium, fast-loading Web Development Company Dubai landing pages, portals, and web apps.',
		outcome:
			'Higher conversion rates, cleaner brand perception, and stronger sales pipelines.',
		icon: '💻',
		color: '#FF416C',
	},
	{
		...
		solution:
			'CRM Development Dubai workflows with pipelines, reminders, dashboards, and integrations.',
		outcome:
			'Better follow-up, clearer accountability, and measurable revenue operations.',
		icon: '🔄',
		color: '#FF4B2B',
	},
	{
		...
		solution:
			'Mobile App Development Dubai for iOS, Android, internal teams, and customer portals.',
	...
	},
	{
		...
		solution:
			'ERP Solutions UAE and HRMS systems tailored to department workflows.',
		outcome:
			'Less manual work, cleaner reporting, and faster management decisions.',
		icon: '⚙️',
		color: '#FF416C',
	},
	{
		...
		solution:
			'AI Automation Dubai systems for qualification, routing, summaries, and internal assistants.',
		outcome:
			'Faster response times and leaner operating costs without losing control.',
		icon: '🤖',
		color: '#FF4B2B',
	},
	{
		...
		solution:
			'SEO Agency Dubai campaigns connected to landing pages, CRM, and analytics.',
		outcome:
			'More qualified traffic, better attribution, and lower acquisition waste.',
		icon: '🎯',
		color: '#FF6B6B',
	},
	{
		...
		solution:
			'Dedicated Developers Dubai support with vetted offshore engineers and project managers.',
		outcome:
			'Flexible capacity, lower costs, and dependable delivery momentum.',
		icon: '👨‍💻',
		color: '#FF416C',
	},
];
...
const industries = [
	{
		name: 'Real Estate',
		challenge:
			'Brokerage teams need faster lead capture, property portals, WhatsApp follow-up, and agent reporting.',
		solution:
			'CRM automation, listing websites, lead routing, call tracking, and dashboards.',
	...
	},
	{
		name: 'Recruitment',
		challenge:
			'Candidate pipelines, client jobs, and recruiter follow-ups become difficult to manage at scale.',
	...
	},
	{
		name: 'Logistics',
		challenge:
			'Manual dispatch, shipment visibility, and customer updates create operational drag.',
		solution:
			'Operations portals, driver apps, ERP workflows, and reporting dashboards.',
	...
	},
	{
		name: 'Healthcare',
		challenge:
			'Clinics need appointment flows, patient communication, and secure admin systems.',
		solution:
			'Booking portals, CRM reminders, mobile apps, and clinic automation.',
	...
	},
	{
		name: 'Ecommerce',
		challenge:
			'Growth exposes weak storefronts, inventory workflows, and customer retention systems.',
		solution:
			'Custom commerce builds, integrations, marketing automation, and analytics.',
	...
	},
	{
		name: 'Hospitality',
		challenge:
			'Restaurants and venues need digital ordering, loyalty, reservations, and local visibility.',
		solution:
			'Ordering systems, mobile apps, SEO, campaigns, and CRM retention flows.',
	...
	},
	{
		...
		challenge:
			'Growing teams need dependable internal systems without bloated software spend.',
		solution:
			'ERP, HRMS, approval workflows, intranets, and custom automation.',
...
const advantages = [
	...
	{
		text: 'Dedicated remote developers',
		icon: '👨‍💻',
		detail: 'Vetted senior engineers',
	},
	{
		text: 'UAE timezone-friendly communication',
		icon: '🕐',
		detail: 'Overlap hours daily',
	},
	{
		text: 'Monthly support retainers',
		icon: '🛡️',
	...
	},
	{
		...
		icon: '📈',
		detail: 'Scale up or down instantly',
	},
];
...
const caseStudies = [
	{
		...
		before:
			'Leads and candidates were managed across spreadsheets and WhatsApp chats.',
		after:
			'Centralized CRM, recruiter dashboards, automated follow-up, and client reporting.',
	...
	},
	{
		...
		before:
			'A growing store struggled with slow pages, manual order handling, and weak tracking.',
		after:
			'Optimized storefront, integrated inventory workflows, and automated retention campaigns.',
	...
	},
	{
		...
		before:
			'Ad leads arrived quickly but sales response and attribution were inconsistent.',
		after:
			'Landing pages, CRM routing, WhatsApp alerts, and campaign dashboards.',
	...
	},
	{
		...
		before:
			'HR teams handled attendance, leave, and approvals through email chains.',
		after:
			'Custom HRMS with employee self-service, approvals, and leadership reports.',
	...
	},
	{
		...
		before:
			'A service company relied on calls for bookings and customer updates.',
		after:
			'Customer mobile app, admin console, booking flow, and notification engine.',
		...
		<>
			...
			<main className='dubai-page'>
				...
				<section className='dubai-hero'>
					<div
						className='dubai-skyline'
						aria-hidden='true'
					/>
					<div className='container dubai-hero-grid'>
						<div className='dubai-hero-copy'>
							<span className='dubai-eyebrow'>
								Silent offshore tech team for Dubai businesses and agencies
							</span>
							<h1>
								Your Offshore Development &amp; CRM Team &mdash; Built for Dubai
								Businesses
							</h1>
							<p>
								Scale faster with cost-effective developers, automation systems,
								CRM solutions, and enterprise-grade technology tailored for UAE
								companies.
							</p>
							<div className='dubai-hero-actions'>
								...
								<a
									className='btn btn-outline dubai-outline-btn'
						...
						<div
							className='dubai-hero-visual'
							aria-label='CRM dashboard preview for Dubai business operations'>
				...
				{/* ===== SERVICES ===== */}
				<section
					className='dubai-section dubai-services'
					id='services'>
					<div className='container'>
						<div className='dubai-section-heading'>
							<span className='dubai-eyebrow'>Enterprise service stack</span>
							<h2>
								Technology, CRM, automation, and growth systems for{' '}
								<span className='dubai-gradient-text'>UAE companies</span>
							</h2>
							<p>
								From Web Development Company Dubai projects to AI Automation
								Dubai workflows, we build the systems that help business owners
								scale without heavy local hiring.
							</p>
						</div>
						<div className='dubai-service-grid'>
							{services.map((service, index) => (
								<article
									className='dubai-service-card'
									key={service.title}>
									<div className='dubai-card-graphic'>
										<div className='dubai-service-icon-wrap'>
											<span className='dubai-service-emoji'>
												{service.icon}
											</span>
										</div>
										<span className='dubai-service-number'>
											{String(index + 1).padStart(2, '0')}
										</span>
									</div>
									<h3>{service.title}</h3>
									<p className='dubai-service-pain'>
										<strong>Challenge:</strong> {service.pain}
									</p>
				...
				<section className='dubai-section dubai-challenges'>
					<div className='container dubai-two-column'>
						<div>
							...
							<h2>
								High-growth companies need speed without bloated technical
								overhead.
							</h2>
							<p>
								Dubai teams move fast, but local hiring costs, disconnected
								tools, and slow delivery partners can make digital
								transformation expensive. Makrosys becomes the silent offshore
								extension that builds, automates, integrates, and supports your
								business systems.
							</p>
							<div
								className='dubai-hero-actions'
						...
						<div className='dubai-challenge-panel'>
							{challenges.map((challenge) => (
								<div
									key={challenge.text}
									className='dubai-challenge-item'>
				...
				<section className='dubai-section'>
					<div className='container'>
						<div className='dubai-section-heading'>
							...
							<h2>
								Built around how Dubai industries actually sell, operate, and{' '}
								<span className='dubai-gradient-text'>scale</span>.
							</h2>
						</div>
						<div className='dubai-industry-grid'>
							{industries.map((industry) => (
								<article
									className='dubai-industry-card'
									key={industry.name}>
									...
									<p>
										<strong>Technology:</strong> {industry.solution}
									</p>
				...
				<section className='dubai-section dubai-advantage'>
					<div className='container dubai-two-column'>
						<div>
							...
							<h2>
								Enterprise delivery capacity without enterprise hiring pressure.
							</h2>
							<p>
								Offshore Development UAE support gives Dubai businesses access
								to reliable engineering, CRM, automation, SEO, and product
								execution while keeping monthly budgets flexible.
							</p>
						</div>
						<div className='dubai-comparison'>
							{advantages.map((advantage) => (
								<div
									key={advantage.text}
									className='dubai-advantage-item'>
									...
									<div>
										...
										<span className='dubai-advantage-detail'>
											{advantage.detail}
										</span>
									</div>
								</div>
				...
				<section className='dubai-section'>
					<div className='container'>
						<div className='dubai-section-heading'>
							...
							<h2>
								Realistic delivery outcomes for CRM, ecommerce, HRMS, apps, and{' '}
								<span className='dubai-gradient-text'>automation</span>.
							</h2>
						</div>
						<div className='dubai-case-grid'>
							{caseStudies.map((study) => (
								<article
									className='dubai-case-card'
									key={study.title}>
				...
				<section className='dubai-section dubai-testimonials'>
					<div className='container'>
						<div className='dubai-section-heading'>
							...
							<h2>
								Trusted by UAE-style businesses that need discreet, reliable
								execution.
							</h2>
						</div>
						<div className='dubai-testimonial-grid'>
							{testimonials.map((testimonial) => (
								<article
									className='dubai-testimonial-card'
					...
					<div className='container'>
						<div className='dubai-section-heading'>
							...
							<h2>
								...
								<span className='dubai-gradient-text'>supported launch</span>.
							</h2>
						</div>
						<div className='dubai-process-timeline'>
							{processSteps.map((step, index) => (
								<div
									className='dubai-process-step'
									key={step.title}>
									<div className='dubai-process-connector'>
										...
										{index < processSteps.length - 1 && (
											<div className='dubai-process-line' />
										)}
									</div>
									<div className='dubai-process-content'>
										<span className='dubai-process-number'>
											{String(index + 1).padStart(2, '0')}
										</span>
										<h3>{step.title}</h3>
										<p>{step.desc}</p>
				...
				<section
					className='dubai-section dubai-calendar-section'
					id='consultation'>
					<div className='container dubai-conversion-grid'>
						<div className='dubai-consultation-card'>
							...
							<p>
								Keep one lead flow across the site. The consultation button
								opens the existing Makrosys lead form, so Dubai inquiries use
								the same CRM-ready submission path, service selector, and email
								notification system.
							</p>
							...
							<div className='dubai-hero-actions'>
								...
								<a
									className='btn btn-outline dubai-outline-btn'
									href='https://wa.me/918082012995?text=Hi%20Makrosys%2C%20I%20want%20to%20book%20a%20Dubai%20consultation.'
									target='_blank'
									rel='noopener noreferrer'>
									WhatsApp Instead
								</a>
						...
						<div className='dubai-calendly-card'>
							...
							<p>
								Choose a UAE-friendly slot for a strategy call. We can review
								your CRM, website, app, ERP, SEO, or automation priorities on
								the call.
							</p>
							<iframe
				...
				<section className='dubai-section dubai-faq'>
					<div className='container'>
						<div className='dubai-section-heading'>
							...
							<h2>
								Common questions from Dubai founders, owners, and agencies.
							</h2>
						</div>
				...
				<section className='dubai-final-cta'>
					<div className='container'>
						...
						<p>
							Scale your business with dedicated offshore experts, automation,
							and enterprise-grade solutions.
						</p>
						<div className='dubai-cta-stats'>
							<div className='dubai-cta-stat'>
								<strong>60%</strong>
								<span>Cost Savings</span>
							</div>
						...
						<div className='dubai-hero-actions'>
							...
							<a
								className='btn btn-outline dubai-outline-btn'
								href='https://wa.me/918082012995?text=Hi%20Makrosys%2C%20I%20want%20to%20build%20a%20Dubai%20tech%20team.'
								target='_blank'
								rel='noopener noreferrer'>
								WhatsApp Us
							</a>
